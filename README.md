...
**Version:** 0.1.10.1 (hotfix) | **License:** MIT | **Python:** 3.8+
...
```sh
pipx install https://github.com/Sreyeesh/pipeline-tools/releases/latest/download/pipely-0.1.10.1-py3-none-any.whl
# or
pip install --user https://github.com/Sreyeesh/pipeline-tools/releases/latest/download/pipely-0.1.10.1-py3-none-any.whl
```
...
2. **Bump version:**
   ```sh
   make set-version VERSION=0.1.10.1
   git add pyproject.toml
   git commit -m "chore: bump version to 0.1.10.1"
...
3. **Create and push tag:**
   ```sh
   git tag v0.1.10.1
   git push origin v0.1.10.1
   ```

4. **Upload artifacts to GitHub release:**
   ```sh
   ALLOW_NON_MONDAY=true make release-ansible VERSION=v0.1.10.1 REPO=Sreyeesh/pipeline-tools
   ```
