...
**Version:** 0.1.8.4 (hotfix) | **License:** MIT | **Python:** 3.8+
...
```sh
pipx install https://github.com/Sreyeesh/pipeline-tools/releases/latest/download/pipely-0.1.8.4-py3-none-any.whl
# or
pip install --user https://github.com/Sreyeesh/pipeline-tools/releases/latest/download/pipely-0.1.8.4-py3-none-any.whl
```
