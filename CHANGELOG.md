...
### :sparkles: Changes
 - chore: remove unpublished site assets
 - chore: update changelog (main)
 - chore: remove pages workflow
 - chore: update changelog (main)
 - docs: add OS-specific pipx install steps
 - chore: update changelog (main)
 - chore: remove pages concurrency cancellation
 - chore: update changelog (main)
 - docs: simplify end-user install to pipx
 - chore: update changelog (main)
 - chore: remove binary builds from release workflow
 - docs: switch install guidance to pipx
 - chore: update changelog (main)
 - docs: refresh website feature highlights
 - chore: update changelog (main)
...
- [`779f501`](https://github.com/Sreyeesh/pipeline-tools/commit/779f5011d5599d262b1092c28d56d686c8ccabd5) - build linux artifacts on ubuntu-22.04 *(commit by [@Sreyeesh](https://github.com/Sreyeesh))*
- [`b9a3fd3`](https://github.com/Sreyeesh/pipeline-tools/commit/b9a3fd3353883b64b06ed00ca50a6d6aa58c4f0d) - fetch tags before release validation *(commit by [@Sreyeesh](https://github.com/Sreyeesh))*
...
- [`d723de3`](https://github.com/Sreyeesh/pipeline-tools/commit/d723de3c74ce53f66c04e393425d629a54e5d651) - update changelog (main) *(commit by [@Sreyeesh](https://github.com/Sreyeesh))*
- [`7ad1ff4`](https://github.com/Sreyeesh/pipeline-tools/commit/7ad1ff484a85bbb77b234e99e530f182a3442cb5) - update changelog (main) *(commit by [@Sreyeesh](https://github.com/Sreyeesh))*
